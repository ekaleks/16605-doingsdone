...
<input class="form__input <?php if ($errors['email'] ?? false ||$error_email ?? false || $error_unique ?? false ):?> form__input--error"<?php endif; ?> type="text" name="email" id="email" value="<?= isset($users['email']) ? $users['email'] : ''; ?>" placeholder="Введите e-mail">
...
<?php if (!$error_email && $error_unique):?><p class="form__message"><?= $errors['unique']; ?></p><?php endif; ?>
            ...
            <div class="form__row">
              ...
              <input class="form__input <?php if ($errors['name'] ?? false):?> form__input--error"<?php endif; ?> " type="text" name="name" id="name" value="<?= isset($users['name']) ? $users['name'] : ''; ?>" placeholder="Введите имя">
