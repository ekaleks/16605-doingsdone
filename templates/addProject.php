<h2 class="content__main-heading">Добавление проекта</h2>
        ...
        <form class="form"  action="" method="post">
          <div class="form__row">
            ...
            <input class="form__input <?php if ($errors['name'] || $errors['name_error'] || $errors['unique']):?> form__input--error <?php endif; ?>" type="text" name="name" id="project_name" value="<?= (isset($_form['name'])) ? $_form['name'] : ' ';?> " placeholder="Введите название проекта">
