        ...
        <div class="container container--with-sidebar">
            ...
            <div class="content">
                <section class="content__side">
                    ...
                    <nav class="main-navigation">
                        <ul class="main-navigation__list">
                            ...
                            <li class="main-navigation__list-item">
                                <a class="main-navigation__list-item-link" href="/index.php<?= '?id=' . htmlspecialchars($project['id']); ?>"><?= htmlspecialchars($project['title']); ?></a>
                    ...
                    <a class="button button--transparent button--plus content__side-button" href="addProject.php" target="project_add">Добавить проект</a>
                </section>
